      ...
      return (<>
        <div className="form-area">
          ...
          <div className="row mt-1">
            ...
            <div
              className="col-10 col-xs-10 col-md-10 col-sm-10 col-lg-10"
            >
            ...
            <div
              className="col-2 col-xs-2 col-md-2 col-sm-2 col-lg-2 mt-1 placement"
            >
              <CrossButton
                name="source"
                onChangeInput={() => {
        ...
        <div className="row mt-2">
          ...
          <div
            className="col-5 col-xs-5 col-sm-5 col-md-5 col-lg-5"
          >
            <ButtonControl
              label="Reset"
